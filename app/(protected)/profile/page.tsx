    ...
    switch (id) {
      ...
      case "last_toy":
        return (
          <StatCard
            title="Dernier Ajout"
            value={stats.lastToy.name}
            subtext={stats.lastToy.theme}
      ...
      case "favorite_brand":
        return (
          <StatCard
            ...
            subtext={`${stats.favoriteBrand.count} jouets`}
            icon={faBuilding}
            color="bg-purple-500"
          />
        );
      case "exposed_count":
        return (
          <StatCard
            title="Exposés"
            value={stats.exposedCount}
            subtext={`${stats.exposedPercentage}% de la collection`}
            icon={faEye}
        ...
        <div className="bg-gradient-to-br from-primary to-purple-700 rounded-3xl p-8 shadow-xl text-white relative overflow-hidden">
          <div className="relative z-10">
            <h1 className="text-3xl font-bold font-title">
              {user.user_metadata?.first_name || "Collectionneur"}
            </h1>
