...
export default function Navbar({ prenom, onLogout, onSearchResults, themeId }: NavbarProps) {
  ...
  return (
    <>
      {/* Navbar fixe */}
      <nav className="navbar-fixed bg-blue-600 text-white px-4 py-3 fixed top-0 left-0 right-0 z-50">
        ...
        {menuOpen && (
          <div className="md:hidden mt-3 space-y-4 pb-4 border-t border-blue-500">
            <SearchBar 
              className="flex mt-4"
              placeholder="Rechercher un jouet..."
              onSearchResults={onSearchResults}
