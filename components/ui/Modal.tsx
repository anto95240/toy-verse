...
export default function Modal({ isOpen, onClose, title, children, loading }: ModalProps) {
        ...
        <div className="relative p-6 border-b border-white/10 shrink-0 z-10">
          ...
          <div className="relative flex items-center justify-between">
            ...
            <button 
              ...
              aria-label="Fermer"
            >
              <FontAwesomeIcon icon={faXmark} className="w-5 h-5 text-text-prim group-hover:text-red-400" />
            </button>
          </div>
        </div>
